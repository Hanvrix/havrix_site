...
export default function WebAppDevelopmentPage() {
  ...
  const hero = {
    ...
    subtitle: (
      <>
        Enterprise-grade web architectures and <span className="font-bold text-white">Textile software</span> ecosystems engineered for speed, conversion, and global demand in Tamil Nadu.
      </>
    ),
